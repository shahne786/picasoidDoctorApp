...
class Backend {
    ...
    constructor() {
        firebase.initializeApp({
            apiKey: " AIzaSyAGvKlH3MeEH_32P5VDu8TMIxZSR21hSlQ ",
            authDomain: "picasoid-cab90.firebaseapp.com",
            databaseURL: "https://picasoid-cab90.firebaseio.com/",
            projectId: "picasoid-cab90",
            storageBucket: "picasoid-cab90.appspot.com",
            messagingSenderId: "649524096140",
            appId: "1:649524096140:android:6a5b3e73337ace79245fa9"
        });
    ...
    sendMessage(message) {
      //  this.messagesRef.update({ status: true});
            ...
            for (let i = 0; i < message.length; i++) {
                        ...
                        var zz = '';
                        var kk = message[i].hasOwnProperty('pdf')
                             if (kk == true){
                               zz = message[i].pdf;
                             } else {
                               zz = "";
